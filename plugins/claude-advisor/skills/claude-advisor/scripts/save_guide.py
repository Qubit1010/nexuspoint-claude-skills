#!/usr/bin/env python3
"""Save a Claude guide / advisory output as a local Markdown file.
...
Usage:
    ...
    cat guide.json | python save_guide.py --out ./my-guide.md

Output (stdout):
    {"status": "ok", "path": "C:/.../the-complete-guide-to-claude-2026.md"}
